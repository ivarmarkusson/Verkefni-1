...
public:
    ...
    void setupUi(QMainWindow *DisplayWindow)
    {
        ...
        table_edit_com->setHorizontalHeaderItem(0, __qtablewidgetitem8);
        QTableWidgetItem *__qtablewidgetitem9 = new QTableWidgetItem();
        table_edit_com->setHorizontalHeaderItem(1, __qtablewidgetitem9);
        QTableWidgetItem *__qtablewidgetitem10 = new QTableWidgetItem();
        table_edit_com->setHorizontalHeaderItem(2, __qtablewidgetitem10);
        QTableWidgetItem *__qtablewidgetitem11 = new QTableWidgetItem();
        table_edit_com->setHorizontalHeaderItem(3, __qtablewidgetitem11);
        ...
        table_display_connect->setHorizontalHeaderItem(0, __qtablewidgetitem12);
        QTableWidgetItem *__qtablewidgetitem13 = new QTableWidgetItem();
        table_display_connect->setHorizontalHeaderItem(1, __qtablewidgetitem13);
        ...
        gridLayout->addWidget(tab_sci_com_conn, 0, 0, 1, 1);
    ...
    void retranslateUi(QMainWindow *DisplayWindow)
    {
        ...
        QTableWidgetItem *___qtablewidgetitem8 = table_edit_com->horizontalHeaderItem(0);
        ___qtablewidgetitem8->setText(QApplication::translate("DisplayWindow", "Name", 0));
        QTableWidgetItem *___qtablewidgetitem9 = table_edit_com->horizontalHeaderItem(1);
        ___qtablewidgetitem9->setText(QApplication::translate("DisplayWindow", "Build Year", 0));
        QTableWidgetItem *___qtablewidgetitem10 = table_edit_com->horizontalHeaderItem(2);
        ___qtablewidgetitem10->setText(QApplication::translate("DisplayWindow", "Type", 0));
        QTableWidgetItem *___qtablewidgetitem11 = table_edit_com->horizontalHeaderItem(3);
        ...
        QTableWidgetItem *___qtablewidgetitem12 = table_display_connect->horizontalHeaderItem(0);
        ___qtablewidgetitem12->setText(QApplication::translate("DisplayWindow", "Scientist Name", 0));
        QTableWidgetItem *___qtablewidgetitem13 = table_display_connect->horizontalHeaderItem(1);
        ___qtablewidgetitem13->setText(QApplication::translate("DisplayWindow", "Computer Name", 0));
